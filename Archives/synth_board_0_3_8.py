...
import synth_layout_0_4 as synth_layout
...
class ContentGroup(wx.Panel):
    ...
    def __init__(self, parent, ID,name,column):
        wx.Panel.__init__(self,parent,ID,size=(140,400))
...
def loadConfig(source):
    ...
    quickreference = []
    try:
        f = open(source+"QuickReference.txt")
        for line in f.readlines():
...
class Master:
    ...
    def layout(self):
        ...
        self.config = loadConfig(self.projectroot)
